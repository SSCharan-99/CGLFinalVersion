 ...
 * by under population. Rule 2:Any live life l with two or three live neighbors
 * activelives on to the next generation. Rule 3: Any live lifel with more than
 * three live neighbors dies, as if by over population. Rule 4: Any dead lifel
...
public class Board {
	...
	public Board(int bW, int bH, Cell c[][]) {
		this.bW = bW;
		this.bH = bH;
		this.board=c;
